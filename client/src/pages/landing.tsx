            ...
            <div className="flex flex-col items-center justify-center gap-6 mb-16">
              ...
              <div className="flex flex-col sm:flex-row gap-3 w-full max-w-md">
                <Button
                  variant="outline"
                  size="lg"
                  className="flex-1 h-12 border-2 hover:bg-red-50 dark:hover:bg-red-950 border-gray-200 dark:border-gray-700"
                  onClick={() => {
                    // Trigger Google auth via Firebase
                    const authButtons = document.querySelector('[data-google-auth]');
                    if (authButtons) {
                      (authButtons as HTMLElement).click();
                    } else {
                      // Fallback - show login modal or redirect
                ...
                <Button
                  variant="outline"
                  size="lg"
                  className="flex-1 h-12 border-2 hover:bg-blue-50 dark:hover:bg-blue-950 border-gray-200 dark:border-gray-700"
                  onClick={() => {
                    // Trigger Facebook auth via Firebase
                    const authButtons = document.querySelector('[data-facebook-auth]');
                    if (authButtons) {
                      (authButtons as HTMLElement).click();
                    } else {
                      // Fallback - show login modal or redirect
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button 
                variant="outline"
                size="lg" 
                className="group bg-transparent border-2 border-white/20 text-white hover:bg-white/10 font-medium px-8 py-6 text-lg rounded-xl shadow-lg transition-all duration-300"
